...
from .models import Producto, ImagenProducto, Contacto, ImagenContacto, Nodo, Membresia, ProductoVariedad, Ciclo, Domicilio
...
class ProductoAdmin(admin.ModelAdmin):
    fieldsets = [
        ...
        ('Costos', {'fields': [('costo_produccion', 'costo_financiero', 'costo_transporte')]})
    ]
